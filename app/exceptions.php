 ...
 *         - Skeleton\InvalidStateException
 *         - Skeleton\DuplicateEntryException
 *         - Skeleton\IOException
 *             - Skeleton\FileNotFoundException
 *             - Skeleton\DirectoryNotFoundException
 *     - LogicException = chyba v kódu, který volá metodu, která tuto výjimku vyhodila; lze jí předejít
 *         - InvalidArgumentException
 *             - Skeleton\InvalidArgumentException
 *                 - Skeleton\ArgumentOutOfRangeException
 *         - Skeleton\NotImplementedException
 *         - Skeleton\NotSupportedException
 *             - Skeleton\DeprecatedException
 *         - Skeleton\StaticClassException
 *
 * @author Jan Tvrdík
 */
